            ...
            <div className="w-full flex items-center justify-center bg-[radial-gradient(circle_at_50%_50%,#4B2DBB,transparent_50%)]">
                <div className="relative">
                    ...
                    <div className="absolute -bottom-[7%] -right-[45%]">
                        <TotalVisits totalVisits={4512} />
                    </div>
                    <div className="absolute top-[20%] -left-[45%] -z-10">
                        <ProjectCard name="Project 1" description="Description 1" img="/project1.jpg" />
                    </div>
                    <div className="absolute -top-[5%] -left-[55%] -z-10">
                        <ProjectCard name="Project 2" description="Description 2" img="/project2.jpg" />
                    </div>
                </div>
            </div>
        </div>
